...
(function(){
  ...
  function renderDashboard(){
    ...
    let recent=recentIds.map(id=>library.find(x=>x.id===id)).filter(Boolean).slice(0,6);if(!recent.length)recent=[...library].sort((a,b)=>(b.createdAt||0)-(a.createdAt||0)).slice(0,6);
